...
const Footer = () => {
    return (
        <section className="lg:max-w-[1110px] lg:mx-auto relative bg-g-1 sm:bg-transparent pt-22 pb-12 sm:pt-0 sm:pb-0">
            <div className="relative sm:bg-g-1 sm:max-w-8/10 lg:max-w-9/10 flex flex-col sm:flex-row items-center gap-8 sm:gap-15 sm:py-12 lg:py-22 sm:pl-40 lg:pl-72">
                <Link
                    to="/"
                    className="bg-b absolute px-3 py-10 lg:py-20 lg:px-13 left-1/2 -translate-x-1/2 -top-36 sm:left-0 sm:top-0 sm:translate-x-0 sm:bottom-0 flex items-center justify-center"
                >
                    <svg
            ...
            <div className="flex items-center justify-center pt-8 sm:pt-0 sm:absolute sm:top-1/2 sm:-translate-y-1/2 sm:right-0">
                <Button
                    className="flex items-center gap-8 pl-10 pr-7 py-5.5 sm:py-6 group justify-center"
                    path="portfolio"
                >
                    See Our Portfolio
                    <svg
