...
const Leader = ({ img, name, pos }) => {
    return (
        <div>
            <div className="relative group cursor-pointer">
                <img src={img} alt="" className="w-full" />
                <div className="hidden lg:block absolute inset-0 group-hover:bg-b/50 transition-all duration-500" />
                <div className="hidden lg:flex absolute inset-0 items-center justify-center gap-8 opacity-0 group-hover:opacity-100 transition-all duration-500 z-30">
                    <Link to="#">
                        <svg
            ...
            <div className="mt-4">
                <h2 className="text-[2rem] leading-[40px] text-b font-bold">
                    {name}
                </h2>
                <p className="text-[1.125rem] leading-[24px] text-g-4">{pos}</p>
            </div>
        </div>
    );
};
